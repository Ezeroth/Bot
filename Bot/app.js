...
client.on("message", message => {
    if (message.channel.type === 'text' && client.id === '478677061607620609') {
        if (client.user.id === '478677061607620609') {
        ...
        } else if (message.guild.id === '446804554248355842' && message.content.startsWith("member")) {
